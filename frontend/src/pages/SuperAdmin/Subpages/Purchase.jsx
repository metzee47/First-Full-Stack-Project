...
import { useMessage } from "../../../components/useContext";


export function AllPurchase(){

    const tableTitles = ['Code Achat', 'Date Achat', ' Quantite', 'Fournisseur', 'Utilisateur' ,'Note', 'Statut']
    ...
    const handleDelete = async (id) => {
        ...
        if(window.confirm(`Etes-vous sure de vouloir supprimer ${id} de la base de données ?`)){
...
export function AddPurchase(){
    ...
    const handleAddPurchase = (event) =>{
        ...
        if(canContinue){
            ...
            setMessage({
                showMessage: true,
                content: `Champ vide : Remplir tous les champs pour continuer !`,
                errorMessage: true
            })
    ...
    return <div className="container"  >
        ...
        <div className="in-out-container">
            <div className="items">
                ...
                <div className="button"><button onClick={(e) => {
                    handleAddPurchase(e)
                }} disabled={addPurchase}>Continuer</button></div>
            </div>       
